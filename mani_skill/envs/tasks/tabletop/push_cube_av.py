...
@register_env("PushCubeAV-v1", max_episode_steps=50)
class PushCubeAVEnv(BaseEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def _load_scene(self, options: dict):
        ...
        self.cam_mount = self.scene.create_actor_builder().build_kinematic("av_camera")
    ...
    def _default_sensor_configs(self):
        ...
        return [
            CameraConfig(
                "base_camera", pose=sapien.Pose(), width=512, height=512, 
    ...
    def _default_human_render_camera_configs(self):
        # registers a more high-definition (512x512) camera used just for rendering when render_mode="rgb_array" or calling env.render_rgb_array()
        pose = sapien_utils.look_at([6, 7, 6], [0.0, 0.0, 0.35])
