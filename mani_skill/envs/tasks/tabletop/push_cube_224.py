...
@register_env("PushCube224-v1", max_episode_steps=50)
class PushCube224Env(BaseEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def _default_sensor_configs(self):
        ...
        # This position places the camera directly facing the robot while also capturing the table area
        pose = sapien_utils.look_at(eye=[0.8, 0, 0.6], target=[0.0, 0, 0.1])
        return [
            CameraConfig(
                "base_camera",
                pose=pose,
